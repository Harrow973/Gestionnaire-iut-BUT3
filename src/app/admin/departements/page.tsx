      ...
      {departments.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {departments.map((dept) => (
            <div key={dept.id} className="bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow border border-gray-100 overflow-hidden">
          ...
          <div className="bg-white rounded-lg shadow-xl w-full max-w-md">
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label htmlFor="nb_enseignants" className="block text-sm font-medium text-gray-700">Nombre d'enseignants</label>
                  <input
                    type="number"
                    id="nb_enseignants"
                    className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                    value={selectedDepartment.nb_enseignants || 0}
                    onChange={(e) => setSelectedDepartment({...selectedDepartment, nb_enseignants: parseInt(e.target.value) || 0})}
                  />
                </div>
                
                <div>
                  <label htmlFor="nb_etudiants" className="block text-sm font-medium text-gray-700">Nombre d'étudiants</label>
                  <input
                    type="number"
                    id="nb_etudiants"
                    className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                    value={selectedDepartment.nb_etudiants || 0}
                    onChange={(e) => setSelectedDepartment({...selectedDepartment, nb_etudiants: parseInt(e.target.value) || 0})}
                  />
                </div>
              </div>
